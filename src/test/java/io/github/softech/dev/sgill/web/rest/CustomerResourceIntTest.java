...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_PHONE = "664.281.4200";
    private static final String UPDATED_PHONE = "(532)-1106979";

    private static final String DEFAULT_STREETADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_STREETADDRESS = "BBBBBBBBBB";

    private static final String DEFAULT_POSTALCODE = "W7U 0D6";
    private static final String UPDATED_POSTALCODE = "Z8A 2Q2";
