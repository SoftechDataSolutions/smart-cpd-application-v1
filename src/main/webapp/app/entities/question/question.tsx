...
import { getSearchEntities, getEntities, reset } from './question.reducer';
    ...
    return (
      <div>
        <h2 id="question-heading">
          <Translate contentKey="smartcpdv1App.question.home.title">Questions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="smartcpdv1App.question.home.createLabel">Create new Question</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('smartcpdv1App.question.home.search')}
                  />
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('textQuestion')}>
                    <Translate contentKey="smartcpdv1App.question.textQuestion">Text Question</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('difficulty')}>
                    <Translate contentKey="smartcpdv1App.question.difficulty">Difficulty</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="smartcpdv1App.question.quiz">Quiz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {questionList.map((question, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{question.quiz ? <Link to={`quiz/${question.quiz.id}`}>{question.quiz.name}</Link> : ''}</td>
