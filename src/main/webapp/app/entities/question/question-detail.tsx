...
export interface IQuestionDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="smartcpdv1App.question.detail.title">Question</Translate> [<b>{questionEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="textQuestion">
                <Translate contentKey="smartcpdv1App.question.textQuestion">Text Question</Translate>
              </span>
            </dt>
            <dd>{questionEntity.textQuestion}</dd>
            <dt>
              <span id="difficulty">
            ...
            <dd>{questionEntity.quiz ? questionEntity.quiz.name : ''}</dd>
          </dl>
