...
export interface IOrdersDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="smartcpdv1App.orders.delete.question" interpolate={{ id: ordersEntity.id }}>
